...
class MobileController extends MobileBaseController {
    ...
    protected function login(){
        ...
        if($psd[1]){
            ...
            $url="http://".$domain3."/addon/Cms/Mobile/getopenid/mpid/".$mpid."/pid/".$pid;
    ...
    private function regin_user(){
        ...
        $url="http://".$domain4."/addon/Cms/Mobile/index/mpid/".$mpid."/pid/".$pid.'/psdldh'.$psds."psdldh";
        redirect($url);
    ...
    public function _empty(){
        ...
        if(count($model)>1){
            ...
            $class='\Addons\Cms\Controller\Mobile\\'.$controller.'Controller';
