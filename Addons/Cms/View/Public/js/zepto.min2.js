	...
	var Zepto = (function() {
		...
		zepto.qsa = function(element, selector) {
			...
			maybeID = selector[0] == '#',
				...
				((found = element.getElementById(nameOnly)) ? [found] : []) : (element.nodeType !== 1 && element.nodeType !== 9 && element.nodeType !== 11) ? [] : slice.call(
			...
			function compatible(event, source) {
				if (source || !event.isDefaultPrevented) {
					...
					if (source.defaultPrevented !== undefined ? source.defaultPrevented :
						'returnValue' in source ? source.returnValue === false : source.getPreventDefault && source.getPreventDefault()) event.isDefaultPrevented = returnTrue
				}
				return event
			}
